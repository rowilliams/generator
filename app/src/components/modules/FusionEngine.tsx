...
const PRODUCERS: Producer[] = [
  ...
  { name: 'DJ PREMIER',     era: '1990s–NOW',  color: '#888888', tags: ['Classic','NY','Scratches'],      bpm: '85–100',  darkness:60, energy:70, grit:80 },
  ...
  { name: "NO I.D.",        era: '1990s–NOW',  color: '#888888', tags: ['Chi','Soulful','Sample-Based'],  bpm: '80–95',   darkness:45, energy:65, grit:55 },
