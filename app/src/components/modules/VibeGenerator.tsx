...
const VIBES: VibeConfig[] = [
  ...
  { id: 'east_coast',       label: 'EAST COAST',         color: '#888888', tags: ['Raw','Jazz-Influenced','NY'],       bpm: '90–100',   scale: 'dorian',          key: 'D',  darkness:55, energy:70, grit:65, swing:55, cinematic:20, melodyDensity:60, bassWeight:60, atmosphere:30 },
